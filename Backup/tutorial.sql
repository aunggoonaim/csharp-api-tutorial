...
CREATE TABLE `user_role` (
  ...
  `role_name` varchar(60) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `user_info` (
  ...
  CONSTRAINT `user_role_id` FOREIGN KEY (`user_role_id`) REFERENCES `user_role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-24 20:16:16
